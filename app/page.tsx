  ...
  return (
    <>
      <div className={`${inter.className}`}>
        ...
        {/* Why choose us */}
        <div className="why-choose-us-wrapper px-[100px] py-[120px] bg-[#F8F5F7]">
          <div className="header-content-row flex flex-row item-center justify-between">
            <div className="lhs w-1/2">
              <div className="bg-gradient-to-r from-[#DCD5FA] to-transparent border-l-4 border-[#664CDD] w-[200px]">
                <h2 className="px-[10px] py-[5px] text-[14px] font-bold text-gray-800">
                  WHY CHOOSE CREST
                </h2>
              </div>

              <h1 className="text-[48px] text-[#191919] font-bold mt-[24px]">
                The Key Benefits of <br />Choosing us!
              </h1>
            </div>
            <div className="rhs w-1/2 text-[#525252] text-[18px]">
              <h1>We combine AI expertise, domain knowledge, and a client-first mindset to deliver tailored, transformative solutions in Finance, Media, Tech and Pharma. No fluff — just focused tools that solve real problems.</h1>
            </div>
          </div>

          <div className="carousel-wrapper mt-[32px]">
            <Carousel>
              <CarouselContent>
                <CarouselItem className="basis-1/4">
                  <div className="card-main bg-red-200 w-[300px] rounded-[32px] overflow-hidden">

                    <Image src="/export-team.svg" alt="hero-illustration" width={300} height={260} style={{ objectFit: "contain" }} />

                    <div className="inner-card p-[24px] bg-white flex flex-col item-start">
                      <Image src="/Expert-Team-Icons.svg" alt="hero-illustration" width={60} height={60} style={{ objectFit: "contain" }} />

                      <h1 className='text-[#191919] text-[18px] font-bold mt-[18px]'>Expert Team</h1>
                      <p className='text-[#525252] text-[14px] font-medium mt-[12px]'>Skilled Mortgage &amp; Title professionals with the ability to scale on demand —
                        ensuring quality and flexibility.</p>
                    </div>
                  </div>
                </CarouselItem>
                <CarouselItem className="basis-1/4">
